...
with st.sidebar:
    ...
    st.title("Hint")
    st.info("For analysis open any WhatsApp group or individual contact, click on 3 dots, select more, export chat (without media), and upload below.")
...
if selected == 'Introduction page':
    ...
    with col2:
        ...
        st.write("Using this project, you can analyze the chats of any WhatsApp group.")
    ...
    st.subheader("Let's Analyse the chats")
